			...
			{displayManagePost ? (
				...
				<div className="post-container">
					...
					<div className="post-description">
						...
						exercitationem magnam omnis velit provident nostrum quibusdam, esse
						autem voluptates accusantium vero officiis, deleniti, dignissimos
						enim aliquid! Molestias dicta fugiat nobis enim? Vel!
					</div>
					...
					<div className="post-comment">
						<div className="big-comment">
							...
							<div className="post-description-big">
								...
								Tenetur omnis nam blanditiis accusamus, libero nobis! Cumque et
								exercitationem magnam omnis velit provident nostrum quibusdam,
								esse autem voluptates accusantium vero officiis, deleniti,
								dignissimos enim aliquid! Molestias dicta fugiat nobis enim?
								Vel!
							</div>
