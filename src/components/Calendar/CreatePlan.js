  ...
  return (
    <div className="create-plan-container">
      <div className="calendar-picker-container">
        {displayDayPicker && (
          <BasicCalendar onChange={setDayPicker} value={dayPicker} />
        )}
      </div>
      {openfilekindofplan ? (
        <div className="create-plan-box">
          ...
          <div className="notice-create-plan-container">
            <textarea rows="" cols="" placeholder="Chú thích"></textarea>
          </div>
          <div className="button-delete-create-plan-container">
            <button onClick={handleCancel}>Hủy</button>
            <button>Tạo</button>
        ...
        <Kindofplan filteringPlan={displayTagPlan} close={showCreatePlan} />
      )}
      {openfilegotoplace && (
        <div className="go-to-palace-container">
          <div className="go-to-palace-tittle">
