  ...
  return (
    <div className="create-plan-container">
      {loading ? (
        ...
        <div ref={refOne} className="create-plan-box">
          ...
          <div className="type-create-plan-container">
                ...
                {isTagChoice ? (
                  <div className="tag-type-create-plan__box">
                    <div
                      ...
                      className="tag-type-create-plan"
                    ></div>
            ...
            <div className="tag-type-create-plan-container">
              <div className="tag-type-create-plan-box-4">
                {tagPlan.map((item) => {
                  return (
                    <div key={item.id} className="array-of-tag-plan">
                      <div
          ...
          <div className="go-together-create-plan-container">
            ...
            >
              {(selected.length > 5 && displayMorePartner
                ...
                return (
                  <div key={user.id} className="partner-together-item">
                    {user.username},
                  </div>
                );
              })}
          ...
          <div className="notice-create-plan-container">
            <textarea onChange={noticeData} placeholder="Chú thích"></textarea>
          </div>
